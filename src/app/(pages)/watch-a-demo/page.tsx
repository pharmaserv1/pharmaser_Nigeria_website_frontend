...
const WatchDemo = () => {
  ...
  return (
    <section className="pt-20 bg-white px-4 lg:px-20 flex flex-col items-center lg:space-y-[60px] mb-10">
      <div className="flex flex-col md:flex-row items-center justify-between xl:w-[1152px] mb-[60px] xl:gap-20 ">
          ...
          >
            ...
            <div className="w-full md:w-[90%] md:max-w-[416px]">
              ...
              >
                {loading
                  ? lang('Submitting') + '...'
                  : lang('SignUpAndWatchNow')}
              </button>

              <div className="w-full flex justify-center items-center gap-3 my-3">
                <div className="w-1/2 h-[1px] bg-[#DCE4E8]"></div>
                <p className="text-center text-xs text-[#747474] font-medium">
                  {lang('OR')}
                </p>
                <div className="w-1/2 h-[1px] bg-[#DCE4E8]"></div>
              </div>
              <button
                type="button"
                className={`w-full  flex justify-center py-3 px-4 border border-[#DCE4E8] rounded-[8px] text-sm text-blue
                 bg-white `}
                onClick={() => router.push('/demo')}
              >
                {lang('SkipSignUpAndWatchNow')}
              </button>
            </div>
          </form>
        </div>
